"""r2_config.py -- R2-FREEZE configuration (2026-07-16, user-approved):
headline field = denoised m_min>=5 (knn-median fallback, field_r2.npz);
kappa_perp reference = 0.3 (degraded-feedback); flanks {0.1, 1.0}.
All other constants inherited frozen from bd_config R-0.
...
KAPPA_PERP_MAIN = 0.3   # R2 reference (degraded-feedback)
KAPPA_PERP_SWEEP = [0.1, 1.0]           # R2 flanks around the 0.3 reference
